const APP_CACHE = 'pokemon-kartenalbum-app-v12';
const CONTENT_CACHE = 'pokemon-kartenalbum-content-v12';
const APP_FILES = ['./','./index.html','./styles.css?v=12','./app.js?v=12','./manifest.webmanifest','./icon.svg','./apple-touch-icon.png','./icon-512.png'];
