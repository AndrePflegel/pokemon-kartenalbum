const APP_CACHE = 'pokemon-kartenalbum-app-v11';
const CONTENT_CACHE = 'pokemon-kartenalbum-content-v11';
const APP_FILES = ['./','./index.html','./styles.css?v=11','./app.js?v=11','./manifest.webmanifest','./icon.svg','./apple-touch-icon.png','./icon-512.png'];
